...
const LANDING_COPY = {
  ru: {
    ...
    metaDescription:
      "MindPulse помогает knowledge workers планировать работу с учетом энергии, когнитивной и эмоциональной нагрузки.",
    header: {
      login: "Войти",
    ...
    hero: {
      kicker: "AI Energy OS для knowledge workers",

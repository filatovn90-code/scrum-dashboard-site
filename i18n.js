...
const messages = {
  ru: {
    ...
    public: {
      ...
      benefit2Title: "Когнитивная нагрузка",
      benefit2Body: "Отмечайте, насколько задача умственно тяжела, и не перегружайте день лишними сложными блоками.",
      benefit3Title: "Сигналы состояния",
      ...
      step2Title: "Создаешь проекты и задачи",
      step2Body: "Формируешь свой рабочий контур без общего списка на всех пользователей.",
      step3Title: "Оцениваешь нагрузку и энергию",
      step3Body: "Добавляешь тип задачи, сложность и ежедневное состояние, чтобы видеть реальную цену задач.",
      step4Title: "Видишь, как распределяется фокус",
      step4Body: "Аналитика показывает, какие задачи усиливают перегруз, а какие поддерживают устойчивый ритм.",
      pricingTitle: "Тарифы",
  ...
  en: {
    ...
    public: {
      ...
      heroDescription: "MindPulse helps you plan work around your energy, cognitive load, and risk of overload. It is more than a task tracker — it is a working system that shows when to go deep and when to slow down and protect your focus.",
      inside: "What’s inside",
      inside1: "Task and project planning around real daily capacity",
      inside2: "Cognitive and emotional load tracking",
      inside3: "Daily energy, stress, and focus check-ins",
      inside4: "Personal analytics on state, pace, and overload",
      inside5: "Private data for every user",
      benefitsKicker: "Benefits",
      benefitsTitle: "Why it helps",
      benefit1Title: "Plan around energy",
      benefit1Body: "Build your day so the hardest work lands in the right energy windows, not just in free slots.",
      benefit2Title: "Cognitive load",
      benefit2Body: "Mark how mentally demanding a task is and avoid stacking too many heavy tasks into one day.",
      benefit3Title: "State signals",
      benefit3Body: "Track energy, stress, and focus to see how workload affects your state.",
      benefit4Title: "Overload risk",
      benefit4Body: "MindPulse helps you notice overload earlier and make more realistic planning decisions.",
      howKicker: "How it works",
      howTitle: "How it works",
      step1Title: "Create an account",
      step1Body: "Start your personal system for managing energy and tasks.",
      step2Title: "Create projects and tasks",
      step2Body: "Build your own work environment without a shared global list.",
      step3Title: "Rate load and energy",
      step3Body: "Add task type, difficulty, and daily state to see the real cost of work.",
      step4Title: "See where focus goes",
      step4Body: "Analytics show which tasks push overload and which ones support a sustainable rhythm.",

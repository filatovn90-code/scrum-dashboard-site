...
const messages = {
  ru: {
    ...
    public: {
      ...
      aiKicker: "AI Coach",
      aiTitle: "AI помогает не просто считать задачи, а объяснять, как собрать устойчивый день",
      aiBody: "MindPulse развивает коучинговый слой поверх задач, состояния и истории недели. Уже сейчас продукт даёт понятные рекомендации, а глубокий AI-разбор подготавливается как следующий уровень.",
      ...
      analyticsTitle: "Понимай свои закономерности, а не только список задач",
      analyticsBody: "Аналитика помогает увидеть, какие дни оказываются самыми плотными, после каких задач падает энергия и как меняются стресс и фокус по ходу недели.",
      analyticsPoint1: "Состояние по дням",
      analyticsPoint2: "Нагрузка и риск перегруза",
      analyticsPoint3: "Личные паттерны работы",
      audienceKicker: "Для кого создан продукт",
      audienceTitle: "MindPulse особенно полезен там, где задач много, а ресурс не бесконечен",
      audience1Title: "Менеджеры и лиды",
      audience1Body: "Когда день состоит из встреч, согласований и сложных решений, важно видеть не только время, но и остаток ресурса.",
      audience2Title: "Специалисты с глубокой работой",
      audience2Body: "Аналитика, дизайн, тексты, архитектура и исследование требуют концентрации. MindPulse помогает не размывать такие блоки.",
      audience3Title: "Люди с высокой когнитивной нагрузкой",
      audience3Body: "Если день быстро перегружается от контекста, эмоций и коммуникации, продукт помогает сделать ритм устойчивее.",
      useCasesKicker: "Сценарии использования",
      useCasesTitle: "Когда MindPulse особенно полезен",
      useCase1Title: "Собрать реалистичный день",
      useCase1Body: "Понять, какие задачи действительно стоит сделать сегодня, а какие лучше перенести без чувства вины.",
      useCase2Title: "Сбалансировать неделю",
      useCase2Body: "Увидеть слишком плотные дни заранее и разнести сложные задачи по более устойчивому ритму.",
      useCase3Title: "Понять причины усталости",
      useCase3Body: "Отследить, какие типы задач и сочетания нагрузки чаще всего снижают фокус и повышают стресс.",
      proofKicker: "Ранний доступ",
      proofTitle: "Продукт развивается вместе с первыми пользователями",
      proofBody: "MindPulse уже помогает собирать более реалистичный план дня и недели. Сейчас особенно ценно живое использование и обратная связь на реальных рабочих сценариях.",
      proofCtaGuest: "Начать бесплатно",
      proofCtaAuthed: "Перейти в рабочее пространство",
      proofNote: "Без вымышленных отзывов и цифр: только честный ранний доступ.",
      ...
      footerLanguage: "Язык",
      footerLanguageValue: "Русский / English",
  ...
  en: {
    ...
    public: {
      ...
      aiKicker: "AI Coach",
      aiTitle: "AI should not just count tasks — it should help explain how to build a sustainable day",
      aiBody: "MindPulse is building a coaching layer on top of your tasks, daily state, and weekly rhythm. Today it already offers useful recommendations, while deeper AI analysis is being prepared as the next level.",
      ...
      analyticsTitle: "Understand your work patterns, not just your task list",
      analyticsBody: "Analytics helps you see which days become dense, after which tasks energy drops, and how stress and focus change across the week.",
      analyticsPoint1: "State by day",
      analyticsPoint2: "Workload and overload risk",
      analyticsPoint3: "Personal work patterns",
      audienceKicker: "Who it is for",
      audienceTitle: "MindPulse is most useful where tasks are many and capacity is limited",
      audience1Title: "Managers and leads",
      audience1Body: "When the day is full of meetings, alignment, and difficult decisions, it helps to see not only time but also the remaining capacity.",
      audience2Title: "People doing deep work",
      audience2Body: "Analytics, design, writing, architecture, and research need concentration. MindPulse helps keep those blocks protected.",
      audience3Title: "People under heavy cognitive load",
      audience3Body: "If your day gets overloaded by context switching, emotions, and communication, the product helps build a steadier rhythm.",
      useCasesKicker: "Use cases",
      useCasesTitle: "When MindPulse is especially useful",
      useCase1Title: "Build a realistic day",
      useCase1Body: "Understand what is truly worth doing today and what is better to move without guilt.",
      useCase2Title: "Balance a full week",
      useCase2Body: "Spot overly dense days in advance and spread difficult work across a steadier rhythm.",
      useCase3Title: "Understand why you get tired",
      useCase3Body: "Track which task types and load combinations most often reduce focus and increase stress.",
      proofKicker: "Early access",
      proofTitle: "The product is evolving together with its first users",
      proofBody: "MindPulse already helps build more realistic daily and weekly plans. Right now, real usage and honest feedback on real work scenarios are especially valuable.",
      proofCtaGuest: "Start for free",
      proofCtaAuthed: "Go to workspace",
      proofNote: "No fake testimonials or invented metrics — only honest early access.",
